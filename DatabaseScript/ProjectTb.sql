...
from ProjectTb pt,UserInfoTb ui,UserRelatedItems u,ProjectImageTb pit
 ...
 update ProjectTb set ReleaseStatus='已结束' where ProjectID='102'
...
insert into ProjectTb values('',1001,'123456789@qq.com','出版','《抹不掉的军人底色》杨福江/著 单价49元',22,'科学技术','科学技术是第一生产力',10000,500,102,'中国北京','发布中',getdate(),'2019-02-01 11:36:23')
insert into ProjectTb values('',1001,'123456789@qq.com','出版','《知行者说1-公益新生代访谈录》 -- 中国公益与NGO的创业史',20,'科学技术','科学技术是第一生产力',1000,200,102,'湖北武汉','发布中',getdate(),getdate())
...
insert into ProjectTb values('',1001,'123456789@qq.com','出版','【众筹扶贫牵手陇南】中秋礼遇—文县花椒 送给亲人的最佳礼品',20,'是曾道人人太少','热压伤',1000,200,422,'湖北武汉','发布中',getdate(),getdate())
