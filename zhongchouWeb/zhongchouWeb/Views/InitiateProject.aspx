<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InitiateProject.aspx.cs" Inherits="zhongchouWebYZ.Initiate_project" %>
    ...
    <form id="form1" runat="server">
        ...
        <div id="content">
            ...
            <div class="center-left">
                ...
                <asp:TextBox ID="TextBox1" runat="server" Width="360px" Height="30px" CssClass=""></asp:TextBox>
                <br />
                <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button ID="Buttonn1" runat="server" Text="科技" OnClick="Buttonn1_Click" />
                &nbsp;&nbsp;&nbsp;
                <asp:Button ID="Buttonn2" runat="server" Text="艺术" OnClick="Buttonn2_Click" />
                &nbsp;&nbsp;&nbsp;
                <asp:Button ID="Buttonn3" runat="server" Text="设计" OnClick="Buttonn3_Click" />
                &nbsp;&nbsp;&nbsp;
                <asp:Button ID="Buttonn4" runat="server" Text="音乐" OnClick="Buttonn4_Click" />
                &nbsp;&nbsp;&nbsp;
                <asp:Button ID="Buttonn5" runat="server" Text="影视" OnClick="Buttonn5_Click" />
                &nbsp;&nbsp;&nbsp;
                <asp:Button ID="Buttonn6" runat="server" Text="出版" OnClick="Buttonn6_Click" />
                &nbsp;&nbsp;
                <asp:Button ID="Buttonn7" runat="server" Text="动漫游戏" OnClick="Buttonn7_Click" />
                &nbsp;&nbsp;&nbsp;
                <asp:Button ID="Buttonn8" runat="server" Text="工艺" OnClick="Buttonn8_Click" />
                &nbsp;&nbsp;&nbsp;
                <asp:Button ID="Buttonn9" runat="server" Text="公开课" OnClick="Buttonn9_Click" />
                &nbsp;&nbsp;&nbsp;
                <asp:Button ID="Buttonn10" runat="server" Text="农业" OnClick="Buttonn10_Click" />
                <br />
                <br />
...
[('杭州')]];
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 项目简介：<asp:TextBox ID="TextBox5" runat="server" Height="123px" Width="251px" TextMode="MultiLine"></asp:TextBox>
                <br />
                <br />
                &nbsp;<br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 项目详情：<asp:TextBox ID="TextBox8" runat="server" Height="114px" Width="270px" TextMode="MultiLine"></asp:TextBox>
                <br />
                <br />
                <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 标签：<asp:TextBox ID="TextBox7" runat="server" Height="42px" Width="225px"></asp:TextBox>
                <br />
                <br />
                <br />

                <asp:Button ID="Button12" runat="server" Text="下一步" BackColor="#FF6600" Height="50px" Width="60px" OnClick="Button12_Click" />
                <br />
                <br />
                <br />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <div class="center-right">
                <div class="shang">
                    ...
                    <asp:Label ID="Label12" runat="server" Text="label" Font-Size="Large" ForeColor="White"  ></asp:Label>
                    <br />
                    <asp:Label ID="Label18" runat="server" Text="Label" Font-Size="Large" ForeColor="White" ></asp:Label>
                </div>
                <div class="xia">
                    &nbsp;&nbsp;<br />
                    &nbsp;&nbsp;&nbsp;
                    <asp:Label ID="Label13" runat="server" Text="Label" Width="130px"></asp:Label>
                    <br />
                    <br />
                    &nbsp;
                    ...
                    <asp:Label ID="Label17" runat="server" Font-Size="Smaller" Text="Label"></asp:Label>
                    <br />
                </div>
            </div>
        </div>
        ...
        <div id="content2" style="text-align: center">
            ...
            <div class="center-left2">
                ...
                <br />
                <br />
                <asp:Button ID="Button3" runat="server" Text="下一步" Height="47px" Width="144px" BorderColor="Red" OnClientClick="bb() " />
                &nbsp;
                <asp:Button ID="Button4" runat="server" Height="47px" Text="上一步" Width="144px" BorderColor="Red" ForeColor="Black" OnClick="Button4_Click" />
            </div>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <div id="content3">
            <div class="center-left3">
                ...
                <select id="sheng1">
                    <option>--请选择--</option><option>--rg择--</option>
 ...
 [('杭州')]];
                         inserts1();
                         function inserts1() {
                             var vshengs = document.getElementById("sheng1");//找到省的下拉框
                             for (var i = 0; i < shengarrs.length; i++) {
                                 var opp = document.createElement("option");
                                 opp.innerHTML = shengarrs[i];
                                 opp.value = i; //value 是不会在前端显示出来的 和winform中的tag属性有点类似   程序员可以通过它去取到对应的内容
                                 vshengs.appendChild(opp);//appendChild  把vsheng的值移除到opp中
                             }
                         ...
                         function inserts2() {
                             ...
                             var vshis = document.getElementById("shi1");
                             vshis.options.length = 0;
                             var cityarr = citys[parseInt(id)];
                             for (var i = 0; i < cityarr.length; i++) {
                                 var cpp = document.createElement("option");
                                 cpp.innerHTML = cityarr[i];
                                 cpp.value = i;
                                 vshis.appendChild(cpp);
                             }
                ...
                <asp:Button ID="Bt1" runat="server" Font-Size="X-Large" Text="上一步" OnClientClick="bb1()" />
                &nbsp;&nbsp;
                <asp:Button ID="Bt2" runat="server" Font-Size="X-Large" Text="保存草稿" />
                <asp:Button ID="Bt3" runat="server" Font-Size="X-Large" Text="提交审核" OnClick="Bt3_Click" />
